  ...
  if (!documentId || !titleSlug) {
    ...
    loadAllCSVs()
      .then(data => {
        ...
        const downloadUrl = `https://ilide.info/docgeneratev2?fileurl=https://scribd.vdownloaders.com/pdownload/${doc.ID}/${doc.Title}&title=${encodedTitle}&utm_source=scrfree&utm_medium=queue&utm_campaign=dl&h=aa%2F0TdL7sPQ4OwEr0UywfA%3D%3D`;
